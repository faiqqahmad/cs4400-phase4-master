...
const selectableFields = {
    ...
    personID: { query: "passenger/personID", exists: true },
};

const procedureName = "Remove_Passenger_Role";

export default function Remove_Passenger_Role() {
	const {
		handleSubmit,
		register,
		control,
	...
	const onSubmit = async (data) => {
		...
		// may need to force passenger to disembark if they are on a flight in sql procedure
		if (errors.length > 0) {
			return alert(
