...
const selectableFields = {
	...
	routeID: { query: "route_path/routeID", exists: true },
	legID: { query: "leg/legID", exists: true },
};

const procedureName = "Extend_Route";

export default function Extend_Route() {
	const {
		handleSubmit,
		register,
		control,
	...
	const onSubmit = async (data) => {
		...
		const procedureInput = [data.routeID, data.legID].map((x) =>
